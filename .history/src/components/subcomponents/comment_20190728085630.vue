  ...
  <div class="cmt-container">
    ...
    <div class="cmt-list">
      <div class="cmt-item" v-for="(item,i) in comments" :key="item.comId">
        <div class="cmt-title">第{{i+1}}楼&nbsp;&nbsp;用户：{{item.username}}&nbsp;&nbsp;发表时间:{{item.comDate|dateFormat}}</div>
...
export default {
    ...
    methods:{
        ...
        commitComment(){
            this.$http.post('api/addnewscom?newsId='+this.id,{username:'匿名用户',content:this.msg.trim()}).then(
                response=>{
